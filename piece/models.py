...
class Piece(models.Model):
    ...
    dimensions = models.CharField(verbose_name="LxWxD in inches", max_length=255, blank=True, null=True)
    image = models.ImageField(upload_to='piece_images', null=True)
    price = models.FloatField(verbose_name="Numeric price", blank=True, null=True)
    pricing = models.CharField(verbose_name='Anything more sophisticated like "Upon request" or "NFS"', max_length=255, blank=True, null=True)
    replacement_cost = models.FloatField(verbose_name="Redo cost in the rare case that it gets stolen or damaged", blank=True, null=True)
