        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'show', 'input_type': 'select', 'purpose': 'Which show the mailing is about. Required by the show templates, which take the dates, description, event times, curators and artworks from it. Lists shows newest first, and only ones that are public or on the way there.'},
