HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Save the site. It now appears in the Sites list and as a pin on the map (if coordinates are set).',
            'To edit an existing site, open the site detail page and click Edit.',
            'Shows become associated with a site when a staff member links them — contact your developer to configure site–show associations if the Sites feature uses database-level relationships rather than on-show fields.',
