HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Go to the Reviews page. Use the Curation Slideshow button in each section to sort submissions into Selected, Rejected, or Undecided — artworks are sorted highest score first. Decisions save instantly. Alternatively, use the dropdowns on the Submissions page.',
    ...
    },
    {
        ...
        'steps': [
            ...
            'Go to the Submissions page. Artwork cards are sorted by weighted score (highest first). Change each artwork\'s dropdown from Undecided to Selected or Rejected — the page scrolls automatically to the next card after each change so you do not lose your place. The total width of selected flat wall art is shown next to the Selected heading.',
...
ROLE_DOCUMENTATION = {
    ...
    'curator': {
        ...
        'allowed_actions': [
            ...
            'On the Submissions page, artwork cards are sorted by weighted score (highest first). Changing a card\'s status scrolls the page automatically to the next card so you don\'t lose your place.',
        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    {'name': 'Decision dropdown per card', 'input_type': 'dropdown select', 'purpose': 'Set each submission to Undecided, Selected, or Rejected. After changing a card, the page automatically scrolls to the next card in the section so you do not lose your place.'},
