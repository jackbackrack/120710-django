HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Nudging always previews first: you see each message in full, with the step it names, and nothing is sent until you press Send. The email goes out on behalf of the show\u2019s curators (all of them, by name), signed by the venue\u2019s team, with your own address as the reply-to so an artist asking for help reaches you. It links the illustrated how-to guide, and includes the artist\u2019s personal accept link when they have no account yet \u2014 that link is what ties the invitation to whatever email they sign up with.',
