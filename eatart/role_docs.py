HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Supports (pedestals and shelves): a support is a plain box a piece can sit on — a pedestal on the floor/ceiling, a shelf on a wall. Drag one from the "Supports" catalog in the sidebar (or the "+ Add support" button) onto the wall to place it where you drop it, or click to add it at the wall centre. Supports come from the site\'s catalog (staff define them per site). To texture a support, select it and pick from the Texture dropdown in the support panel — the choices are the textures defined on the site\'s catalog, plus "None (white)". The default is white with a black outline.',
        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'Hang info overlay', 'input_type': 'read-only display', 'purpose': 'Shows four edge distances (← left, → right, ↑ top, ↓ bottom in inches) and the artwork dimensions. Text auto-fits inside the artwork card at any zoom level.'},
                    ...
                    {'name': 'Supports catalog / + Add support', 'input_type': 'click or drag', 'purpose': 'Add a pedestal (floor/ceiling) or shelf (wall). Drag a catalog entry or the "+ Add support" button onto the wall to place it where you drop it, or click to add at the wall centre. Drop a piece onto a support to auto-group them.'},
                    {'name': 'Support panel (Texture dropdown)', 'input_type': 'dropdown select', 'purpose': 'With a support selected, set its size/height/rotation, save it to the site catalog, or apply a texture. The Texture list offers the site catalog\'s textures plus "None (white)". Newly-added site-catalog supports appear in the sidebar catalog after reloading the layout page.'},
