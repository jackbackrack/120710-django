        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'Segments (per person)', 'input_type': 'checkboxes and a save button', 'purpose': 'Artist, Collector and Funder for one person. Unticking and saving removes it, unlike the public subscribe form, which only ever adds. "artist profile" underneath means the address matches an artist on file: that cannot be unticked, because it is derived from the profile rather than stored here.'},
