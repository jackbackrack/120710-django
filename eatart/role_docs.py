HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Submit. On your Me page the show appears under "Shows Accepting Submissions" with a Submit button; the show detail page has one too, directly under the submission deadline. Wherever you click it from, it takes you to whichever of these steps you still have left rather than to a page you cannot use yet \u2014 so a submit link shared in an email or a post works for someone who has never been here before. Click it, select the artwork card you want to submit (click it to highlight it), then click Submit. You submit one artwork at a time — repeat for each piece, and each artwork can only be submitted once per show.',
