HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'The Invite Artists page shows a progress table: whether each invited artist has created an account, completed their profile, how many artworks they have uploaded, and how many they have submitted.',
    ...
    },
    {
        ...
        'steps': [
            ...
            'To place an artwork, click it in the sidebar on the left. It appears centered on the selected wall. Drag it left or right to position it along the wall.',
            ...
            'Use the scroll wheel or pinch gesture to zoom. Pan by clicking and dragging on empty canvas space, or use the W A S D keys.',
    ...
    },
    {
        ...
        'steps': [
            ...
            'Click and drag to look around. Move through the space with W A S D or the arrow keys. Move up and down with Q and E. The camera starts at roughly eye level (5 feet from the floor).',
            'Artworks appear on the walls where they were placed in the layout editor. Wall textures (if configured for the site) are applied to floor, ceiling, and each wall.',
        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'Artwork sidebar', 'input_type': 'click or drag', 'purpose': 'Click an artwork thumbnail to place it on the current wall centered. Click a placed artwork\'s thumbnail to jump to its wall and highlight it.'},
                    {'name': 'Canvas drag', 'input_type': 'drag placed artwork', 'purpose': 'Move artwork along the wall. Position is shown live in the bar below the canvas.'},
                    {'name': 'Position bar (below canvas)', 'input_type': 'numeric inputs', 'purpose': 'Edit the exact horizontal position (from left edge) and height (center from floor) in inches. Updates live as you drag.'},
                    ...
                    {'name': 'Delete / Backspace key', 'input_type': 'keyboard', 'purpose': 'Removes the selected artwork(s) from the wall. Equivalent to clicking Remove in the position bar.'},
