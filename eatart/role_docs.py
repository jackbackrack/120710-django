HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'A row reading "Signed \u2014 out of date" means the work in the show has changed since that artist signed. Email them and they will be asked to sign a new version; the old one is kept.',
