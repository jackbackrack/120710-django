HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Click "Ruler" in the toolbar to show tick marks along the wall edges — long ticks every 10 inches, short ticks every inch (horizontal ticks measured from the wall centre, vertical from the floor). The big ticks are labelled with their distance in inches from zero (from the centre along the bottom, from the floor up the left). Tick lengths scale with zoom, and inch ticks/labels appear once you zoom in enough to read them.',
        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'Ruler button', 'input_type': 'button (toggle)', 'purpose': 'Shows a ruler along all four wall edges — long ticks every 10 inches, short ticks every inch. Horizontal ticks are measured from the wall centre, vertical ticks from the floor (matching how positions are stored). Big ticks are labelled with their distance in inches from zero (centre along the bottom, floor up the left). Tick lengths are a fixed size on the wall (they scale with zoom); inch ticks and labels appear once zoomed in enough to read them. Toggle is remembered.'},
