        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'Hang info overlay', 'input_type': 'read-only display', 'purpose': 'Shows the artwork dimensions, the four edge distances (← left, → right, ↑ top, ↓ bottom in inches), and ⊕ the horizontal centre distance from the left wall edge (where to drill the centre hole). If the artwork has a "Hang drop" recorded (bottom edge → hanging point), a 🔩 line also gives the exact screw-hole drill point: ⊕ centre from the left and ↑ height above the floor (bottom-above-floor + hang drop). Text auto-fits inside the artwork card at any zoom level.'},
