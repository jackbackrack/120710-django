        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'Hang info overlay', 'input_type': 'read-only display', 'purpose': 'Shows the artwork dimensions, the four edge distances (← left, → right, ↑ top, ↓ bottom in inches), and ⊕ the horizontal centre distance from the left wall edge (where to drill the centre hole). Text auto-fits inside the artwork card at any zoom level.'},
