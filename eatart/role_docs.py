        ...
        'forms': [
            {
                ...
                'fields': [
                    ...
                    {'name': 'submission_deadline', 'input_type': 'date input', 'purpose': 'Cutoff date for artist submissions (informational). After this date, manually advance the status to Draft to close submissions.'},
