HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Click "Ruler" in the toolbar to show tick marks along the wall edges — long ticks every foot, short ticks every inch (horizontal ticks measured from the wall centre, vertical from the floor). Inch ticks appear once you zoom in enough to read them.',
