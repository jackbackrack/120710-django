HOW_TO_GUIDES = [
    ...
    },
    {
        ...
        'steps': [
            ...
            'Go to Submissions on the show detail page. Use the dropdown on each artwork card to mark it Selected, Rejected, or Undecided. Artists cannot see these decisions yet.',
