        ...
        'forms': [
            ...
            },
            {
                ...
                'fields': [
                    ...
                    {'name': 'Closed on (rows)', 'input_type': 'inline table', 'purpose': 'Dates the gallery is shut whatever the hours say — holidays, or the week between shows. The last day is included. The reason is shown to visitors.'},
