...
class SocialAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def save_user(self, request, sociallogin, form=None):
        ...
        # The Google picture is deliberately not taken. An account with no picture of its own
        # still has one — a monogram — and importing it satisfied the photo requirement without
        # producing a photograph, leaving the gallery chasing a real one after acceptance
        # anyway. Even a genuine Google photo is one the artist never chose for this: it is
        # printed beside their work in the catalogue, and that is worth a deliberate upload.
